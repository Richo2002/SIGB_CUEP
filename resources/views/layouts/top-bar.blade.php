        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle"
                    src="{{ Auth::user()->photo ? '/storage/profiles/'.Auth::user()->photo : '/img/undraw_profile.svg' }}">
            </a>
            <!-- Dropdown - User Information -->
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                aria-labelledby="userDropdown" id="dropdow-user-information">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="/logout" method="POST" class="modal-footer">
                ...
                <button class="btn btn-logout" href="/logout">Déconnexion</button>
            </form>
        </div>
    </div>
</div>
