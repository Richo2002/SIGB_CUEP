            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h3 mb-0 text-gray-800">Enregistrement d'un nouvel prêt</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="/resources">Ressources</a></li>
                              <li class="breadcrumb-item active" aria-current="page">Faire un Prêt</li>
                            </ol>
                          </nav>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold" id="main-title">Formulaire d'enregistrement d'un prêt</h6>
                        </div>
                        <div class="card-body">
                            @livewire('add-loan-form')
                        </div>
                    <div>
                </div>
                <!-- /.container-fluid -->
