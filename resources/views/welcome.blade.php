...
<html lang="en">
  ...
  <body id="page-top">
    <section class="welcome max-vh-100 pb-4 mb-5">
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#catalogues">Catalogue</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Notre Bibliothèque Centrale</h5>
                      <p>Une vaste collection de ressources provenant de plusieurs universités du Bénin.</p>
                    </div>
                  </div>
                ...
                <div class="row d-flex flex-column align-items-center">
                    <div class="col-12">
                        ...
                        <p>
                            ...
                            <a href="mailto:adresse-email@example.com" class="text-decoration-none">adresse-email@example.com</a> Nous mettons tout en œuvre pour vous répondre le plus rapidement possible.
                            <b>Tel: 91 38 00 00</b>
                        </p>
